package Myntra.config

import Myntra.common.constant.SpringProfile
...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/Women.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/Women.properties")),
                "${dir}/Women.properties containing externalized datasource properties must exist"
    }
